...
// public variables
	...
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr push_to_plane(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud, double z_value)
	{
	...
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr remove_ground_plane(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud)
	{
		try{
	...
	//-----------------------------------------------------------------------
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr apply_outlier_filter(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud,int nr, double radius)
	{
